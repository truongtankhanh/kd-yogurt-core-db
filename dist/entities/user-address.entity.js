...
let UserAddressEntity = class UserAddressEntity extends base_entity_1.BaseEntity {
    userId;
    label;
    recipientName;
    phone;
...
], UserAddressEntity.prototype, "label", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'recipient_name', type: 'varchar', length: 100 }),
    __metadata("design:type", String)
], UserAddressEntity.prototype, "recipientName", void 0);
__decorate([
