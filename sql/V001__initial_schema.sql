...
(
    ...
    code       VARCHAR(50)  NOT NULL, -- business key (ADMIN, USER...)
    name       VARCHAR(100) NOT NULL, -- display name
    meaning    TEXT         NOT NULL, -- description
...
(
    ...
    updated_at TIMESTAMPTZ  NOT NULL DEFAULT NOW(),
    deleted_at TIMESTAMPTZ           DEFAULT NULL,
    CONSTRAINT uq_delivery_types_code UNIQUE (code)
);
...
(
    ...
    updated_at  TIMESTAMPTZ  NOT NULL DEFAULT NOW(),
    deleted_at  TIMESTAMPTZ           DEFAULT NULL,
    CONSTRAINT uq_system_settings_code UNIQUE (code)
);
